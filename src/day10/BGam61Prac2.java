...
public class BGam61Prac2 {
    public static void main(String[] args) {
        Mech61Prac2 myMecha = new Mech61Prac2("mecha61Prac2",300,300);
        Tyran61Prac2 tyrant = new Tyran61Prac2("tyrant61Prac2",500,20);
    ...
    public static void showStatus(Mech61Prac2 mecha, Tyran61Prac2 tyrant){
    ...
    public static void handlePlayerTurn(Mech61Prac2 mecha, Tyran61Prac2 tyrant, int choice){
        switch (choice){
            case 1:
    ...
    public static void handleEnemyTurn(Mech61Prac2 mecha, Tyran61Prac2 tyrant){
        if(tyrant.isAlive()){
            tyrant.attack(mecha);
        }
    }
    public static void playRound(Mech61Prac2 mecha, Tyran61Prac2 tyrant, Scanner sc){
        showStatus(mecha, tyrant);
        showMenu();
        handlePlayerTurn(mecha, tyrant, getValidChoice(sc));
        handleEnemyTurn(mecha, tyrant);
    }
    public static void printResult(Mech61Prac2 mecha, Tyran61Prac2 tyrant){
        System.out.println("-------------------------------------------------------");
        if(mecha.isAlive()){
